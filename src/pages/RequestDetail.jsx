...
export default function RequestDetail() {
  ...
  const headerActions = (
    <span className="px-sm py-1 rounded-full text-[12px] font-bold status-in-progress">IN PROGRESS</span>
  )
  ...
  return (
    ...
    >
      ...
      <div className="p-lg grid grid-cols-12 gap-gutter relative z-10">
        {/* Left Column */}
          ...
          <section className="glass-panel rounded-xl p-md">
            ...
            <div className="mt-lg pt-md border-t border-white/10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-sm">
                ...
                <div className="flex flex-col items-center justify-center border-2 border-dashed border-white/10 rounded-lg p-sm hover:border-primary/50 transition-colors cursor-pointer group col-span-1">
          ...
          <section className="glass-panel rounded-xl p-md">
            ...
            <div className="glass-panel-high rounded-xl p-sm">
              ...
              <div className="flex justify-between items-center mt-sm pt-sm border-t border-white/10">
                ...
                <button
                  onClick={postComment}
                  className="bg-primary/20 text-primary border border-primary/30 px-md py-sm rounded-lg text-label-md hover:bg-primary/30 transition-colors active:scale-95"
                >
                  Post Comment
                </button>
              </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-gutter">
          <div className="glass-panel-high rounded-xl p-md space-y-md sticky top-24">
            ...
            <div className="space-y-sm">
              ...
              <div className="flex justify-between items-center py-sm border-b border-white/5">
                ...
                <div className="flex items-center gap-xs">
                  <div className="w-6 h-6 rounded-full overflow-hidden border border-white/20 bg-primary/20">
                    <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVOWLfQ4wqtL-lYO3tD1hudSfIN1aCJUN-YZZv7FBJfdUpi4342vnExJIpu-q01b9Oq_LFy9dr3hi4T6uTyjwHAzTB9791QNushvRXlbw-8ZGOk5eTtCpDXGeHJwLp4vii7erTYU77KbduxClqC8U0baQftC9Jtrvcg2SJDWk1cSyi6uRttS-XbcmPk--lSYC9juqHdFU4U2CSskJOS-klJm7UXOEHFP9q1M7WRisqbh5zF-bQ1b0cug" alt="Sarah Chen" className="w-full h-full object-cover" />
                  </div>
            ...
            <div className="pt-md">
              ...
              <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
                <div className="h-full primary-gradient w-[65%] rounded-full shadow-[0_0_10px_rgba(59,130,246,0.3)]" />
              </div>
            ...
            <button className="w-full py-sm rounded-xl border border-white/10 text-on-surface-variant text-label-md hover:bg-error/10 hover:text-error hover:border-error/20 transition-all flex items-center justify-center gap-xs">
          ...
          <section className="glass-panel rounded-xl p-md">
            ...
            <div className="flex flex-wrap gap-xs">
              {TAGS.map((tag) => (
                <span key={tag} className="px-sm py-1 bg-white/5 border border-white/10 rounded-lg text-[12px] text-on-surface-variant hover:border-primary/40 cursor-default transition-colors">
                  {tag}
                </span>
              ))}
            </div>
